...
exports = Class(ui.View, function (supr) {
    ...
    this.trySwap = function (x1, y1, x2, y2, matchType) {	
        this.updateMoves(x1, y1);
        this.updateMoves(x2, y2);
	...
	this.swapPieces = function (x1, y1, x2, y2) {
        ...
        // get the board tiles
		var tile1 = this.getTile(x1, y1);
        var tile2 = this.getTile(x2, y2);
        ...
        for(var col = 0; col < cols; col++) {
            for(var row = 0; row < rows; row++) {
                if (tiles[col][row] != null) {
                    ...
                    tilesMoving = (tiles[col][row].moving) ? true : tilesMoving;
                }
            }
        }
    }
    ...
    this.shiftTiles = function (toX, toY, fromX, fromY, tile) {
        tiles[toX][toY] = this.getTile(fromX, fromY);
